...
import { Permission, type PermissionAction } from '@modules/iam/adapters/persistence/models/permission.model';
import { RolePermission } from '@modules/iam/adapters/persistence/models/role-permission.model';
import type { PermissionRepository, Id } from '@modules/iam/core/app/ports';
