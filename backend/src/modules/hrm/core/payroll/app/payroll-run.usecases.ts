...
} from '@modules/hrm/core/payroll/domain/contract-segment';
import {
  buildPayrollDoc,
  type PayrollRunContext,
  type PayrollSegmentInput,
} from '@modules/hrm/adapters/persistence/mongoose/payroll/payroll-doc.mapper';
import type { PeriodRecord, PeriodReader, PeriodLifecycle } from '@modules/hrm/core/period/domain/ports';
import type {
  PayrollRepository,
  EmployeeGateway,
  ContractGateway,
