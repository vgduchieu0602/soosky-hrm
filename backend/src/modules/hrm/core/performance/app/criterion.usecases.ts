...
import type { CriterionRepository } from '@modules/hrm/core/performance/domain/ports';
import type { CreateCriterionDto, UpdateCriterionDto } from '@modules/hrm/core/performance/dto/criterion.dto';
