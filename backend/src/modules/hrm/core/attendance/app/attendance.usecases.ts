...
import { vnDateKey, vnMonthRange, type ShiftWindow } from '@modules/hrm/core/attendance/domain/attendance-calc';
import { computeFields, monthsSince } from '@modules/hrm/core/attendance/domain/leave-policy';
import type {
...
import type { LeaveEntitlementService } from '@modules/hrm/core/attendance/app/leave-entitlement.service';
import type { UpsertAttendanceDto, AdjustAttendanceDto } from '@modules/hrm/core/attendance/dto/attendance.dto';
