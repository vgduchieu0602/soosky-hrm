import { z } from 'zod';
import { DOCUMENT_TYPE } from '@modules/hrm/adapters/persistence/mongoose/models/employee-document.model';
import { RELATIONSHIP } from '@modules/hrm/adapters/persistence/mongoose/models/employee-contact.model';
...
import { ASSET_CONDITION } from '@modules/hrm/adapters/persistence/mongoose/models/employee-asset.model';
