...
import {
  ...
  REMINDER_THRESHOLDS,
  type ReminderItem,
} from '@modules/hrm/core/employee/domain/employee-rules';
import type { ReminderRepository, NotificationGateway, Clock } from '@modules/hrm/core/employee/domain/ports';
