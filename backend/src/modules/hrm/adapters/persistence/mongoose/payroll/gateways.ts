...
import {
  ...
  SalaryPolicyConfig,
} from '@modules/hrm/adapters/persistence/mongoose/models/salary-policy-config.model';
...
import { Attendance, type AttendanceStatus } from '@modules/hrm/adapters/persistence/mongoose/models/attendance.model';
import type { PayrollReadinessPort } from '@modules/hrm/core/period/domain/ports';
