...
import {
  ...
  historyController,
  lifecycleController,
} from '@modules/hrm/adapters/http/employee/controllers';
...
import {
  ...
  endEmploymentDto,
  rehireDto,
} from '@modules/hrm/core/employee/dto/lifecycle.dto';

import { createEmployeeDto } from '@modules/hrm/core/employee/dto/create-employee.dto';
import { importPreviewDto, importCommitDto } from '@modules/hrm/core/employee/dto/import-employees.dto';
import { updateEmployeeDto } from '@modules/hrm/core/employee/dto/update-employee.dto';
import { updateProfileDto } from '@modules/hrm/core/employee/dto/update-profile.dto';
import { grantLoginDto } from '@modules/hrm/core/employee/dto/grant-login.dto';
import { updateAccountDto } from '@modules/hrm/core/employee/dto/account.dto';
import {
  createDocumentDto,
  updateDocumentDto,
  createContactDto,
...
} from '@modules/hrm/core/employee/dto/sub-resource.dto';
