...
import {
  ...
  leaveController,
} from '@modules/hrm/adapters/http/attendance/controllers';
import {
  createShiftDto,
  updateShiftDto,
  createHolidayDto,
  ...
  createSymbolDto,
  updateSymbolDto,
} from '@modules/hrm/core/attendance/dto/catalog.dto';
import {
  upsertAttendanceDto,
  adjustAttendanceDto,
  bulkUpsertAttendanceDto,
} from '@modules/hrm/core/attendance/dto/attendance.dto';
import { submitLeaveDto, rejectLeaveDto, upsertLeaveBalanceDto } from '@modules/hrm/core/attendance/dto/leave.dto';
