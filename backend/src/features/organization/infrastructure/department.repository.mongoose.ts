...
import type { DepartmentRow } from '@features/organization/domain/department-tree';
import type { DepartmentDoc, DepartmentRepository, Id, Tx } from '@features/organization/domain/ports';
