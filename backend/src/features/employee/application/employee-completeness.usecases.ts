...
import { isValidObjectId, buildCompleteness, type ChecklistItem } from '@features/employee/domain/employee-rules';
import type { CompletenessGateway } from '@features/employee/domain/ports';
