import { z } from 'zod';
import { CONTRACT_TYPE, EMPLOYMENT_STATUS } from '@shared/models/employee-contract.model';
import { EMPLOYEE_TYPE } from '@shared/models/employee.model';
import { SEPARATION_TYPE } from '@features/employee/domain/employee-lifecycle';
