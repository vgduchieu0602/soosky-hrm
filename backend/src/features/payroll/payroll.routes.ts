...
import { payrollPeriodController } from '@features/payroll/controllers/payroll-period.controller';
import { compensationController } from '@features/payroll/controllers/compensation.controller';
import { payrollController } from '@features/payroll/controllers/payroll.controller';
import {
  createPeriodDto,
  updatePeriodDto,
  runPeriodDto,
